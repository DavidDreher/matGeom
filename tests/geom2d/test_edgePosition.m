...
pos1 = matGeom.geom2d.edgePosition(p1, edge);
pos2 = matGeom.geom2d.edgePosition(p2, edge);
pos3 = matGeom.geom2d.edgePosition(p3, edge);
...
posList = matGeom.geom2d.edgePosition(point, edges);
...
posList = matGeom.geom2d.edgePosition(points, edge);
