...
p1 = [10 20];
p2 = [80 20];
ray = matGeom.geom2d.createRay(p1, p2);

p0 = [10 20];
testCase.assertTrue(matGeom.geom2d.isPointOnRay(p0, ray));
...
p0 = [9.99 20];
testCase.assertFalse(matGeom.geom2d.isPointOnRay(p0, ray));
...
testCase.assertTrue(matGeom.geom2d.isPointOnRay(p1, ray));
testCase.assertTrue(matGeom.geom2d.isPointOnRay(p2, ray));
...
p0 = [20 20];
testCase.assertEqual([true true false], matGeom.geom2d.isPointOnRay(p0, ray));
...
testCase.assertEqual(exp, matGeom.geom2d.isPointOnRay(p0, ray));
...
testCase.assertEqual(exp, matGeom.geom2d.isPointOnRay(p0, [ray;ray;ray;ray]));
