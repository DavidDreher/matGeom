...
line1 = [3 1 0 1];
line2 = [1 4 1 0];
testCase.assertEqual(matGeom.geom2d.intersectLines(line1, line2), [3 4], 'AbsTol', .01);

function testOrthogonalDiagonals(testCase)
% orthognal diagonal lines
line1 = [0 0 3 2];
line2 = [5 -1 4 -6];
testCase.assertEqual(matGeom.geom2d.intersectLines(line1, line2), [3 2], 'AbsTol', .01);
...
line2 = [1 6 1 -1];
testCase.assertEqual(matGeom.geom2d.intersectLines(line1, line2), [4 3], 'AbsTol', .01);
...
inters = matGeom.geom2d.intersectLines(line1, line2);
