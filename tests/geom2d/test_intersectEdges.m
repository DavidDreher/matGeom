...
edge1 = [1 2 5 2];
edge2 = [3 1 3 4];
testCase.assertEqual(matGeom.geom2d.intersectEdges(edge1, edge2), [3 2], 'AbsTol', .01);
testCase.assertEqual(matGeom.geom2d.intersectEdges(edge2, edge1), [3 2], 'AbsTol', .01);

function testParallel(testCase)
% basic test with two parallel edges
edge1 = [1 2 4 4];
edge2 = [2 1 8 5];
testCase.assertTrue(sum(isnan(matGeom.geom2d.intersectEdges(edge1, edge2)))==2);
testCase.assertTrue(sum(isnan(matGeom.geom2d.intersectEdges(edge2, edge1)))==2);

function testColinearIntersect(testCase)
% basic test with two colinear edges
edge1 = [1 2 7 6];
edge2 = [4 4 13 10];
testCase.assertTrue(sum(isinf(matGeom.geom2d.intersectEdges(edge1, edge2)))==2);
testCase.assertTrue(sum(isinf(matGeom.geom2d.intersectEdges(edge2, edge1)))==2);
...
edge1 = [1 2 7 6];
edge2 = [7 6 10 8];
testCase.assertEqual(matGeom.geom2d.intersectEdges(edge1, edge2), [7 6], 'AbsTol', eps);
testCase.assertEqual(matGeom.geom2d.intersectEdges(edge2, edge1), [7 6], 'AbsTol', eps);
...
edge1 = [1 2 50000 2];
edge2 = [3 1 3 4];
testCase.assertEqual(matGeom.geom2d.intersectEdges(edge1, edge2), [3 2]);

function testDiagonal(testCase)
% check diagonal edges
edge1 = [5 1 1 5];
edge2 = [2 2 2 6];
testCase.assertEqual(matGeom.geom2d.intersectEdges(edge1, edge2), [2 4], 'AbsTol', .01);

edge3 = [3 1 6 4];
testCase.assertEqual(matGeom.geom2d.intersectEdges(edge1, edge3), [4 2], 'AbsTol', .01);

function testWithNaN(testCase)
% check comparison with NaN
edge2 = [2 2 2 6];
edge3 = [3 1 6 4];
testCase.assertEqual(matGeom.geom2d.intersectEdges(edge2, edge3), [NaN NaN]);

function testOneCorner(testCase)
% check intersection with one corner
edge1 = [5 1 1 5];
edge2 = [0 5 3 5];
testCase.assertEqual(matGeom.geom2d.intersectEdges(edge1, edge2), [1 5], 'AbsTol', .01);
...
inters = matGeom.geom2d.intersectEdges(edges1, edges2);
