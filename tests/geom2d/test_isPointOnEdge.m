...
p0 = [10 20];
testCase.assertTrue(matGeom.geom2d.isPointOnEdge(p0, edge));
...
p0 = [9.99 20];
testCase.assertFalse(matGeom.geom2d.isPointOnEdge(p0, edge));
...
testCase.assertTrue(matGeom.geom2d.isPointOnEdge(p1, edge));
testCase.assertTrue(matGeom.geom2d.isPointOnEdge(p2, edge));
...
p0 = [20 20];
testCase.assertEqual([true ; true ; false], matGeom.geom2d.isPointOnEdge(p0, edge));
...
testCase.assertEqual(exp, matGeom.geom2d.isPointOnEdge(p0, edge));
...
testCase.assertEqual(exp, matGeom.geom2d.isPointOnEdge(p0, [edge;edge;edge;edge]));
...
exp = [true;false];
testCase.assertEqual(exp, matGeom.geom2d.isPointOnEdge(p0, edges));
