...
p0 = [10 20];
testCase.assertTrue(matGeom.geom2d.isPointOnLine(p0, line));
...
p0 = [50 21];
testCase.assertFalse(matGeom.geom2d.isPointOnLine(p0, line));
...
testCase.assertTrue(matGeom.geom2d.isPointOnLine(p1, line));
testCase.assertTrue(matGeom.geom2d.isPointOnLine(p2, line));
...
p0 = [20 20];
testCase.assertEqual([true true false], matGeom.geom2d.isPointOnLine(p0, line));
...
testCase.assertEqual(exp, matGeom.geom2d.isPointOnLine(p0, line));
...
testCase.assertEqual(exp, matGeom.geom2d.isPointOnLine(p0, [line;line;line;line]));
