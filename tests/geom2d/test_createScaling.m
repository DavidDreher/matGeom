...
trans = matGeom.geom2d.createScaling(2);
testCase.assertEqual(trans, [2 0 0;0 2 0;0 0 1], 'AbsTol', .01);

% different factor
trans = matGeom.geom2d.createScaling(2, 3);
...
trans1 = matGeom.geom2d.createScaling(p0, sx, sy);
t1 = matGeom.geom2d.createTranslation(-p0);
sca = matGeom.geom2d.createScaling(sx, sy);
