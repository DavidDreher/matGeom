...
matGeom.meshes3d.createIcosahedron();


function testVEFCreation(testCase)

[v, e, f] = matGeom.meshes3d.createIcosahedron();
...
mesh = matGeom.meshes3d.createIcosahedron();
...
[v, e, f] = matGeom.meshes3d.createIcosahedron(); %#ok<ASGLU>
