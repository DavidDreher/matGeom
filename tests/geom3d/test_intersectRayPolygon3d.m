...
inter = matGeom.geom3d.intersectRayPolygon3d(line1, pts3d);
exp = [1 2 3];
testCase.assertEqual(exp, inter);

line2 = [10 0 0 1 2 3];

[inter, inside] = matGeom.geom3d.intersectRayPolygon3d(line2, pts3d); %#ok<ASGLU>
...
[inters, inside] = matGeom.geom3d.intersectRayPolygon3d(lines, pts3d);
