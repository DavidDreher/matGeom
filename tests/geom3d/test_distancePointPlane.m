...
point   = [10 10 10];
plane   = matGeom.geom3d.createPlane([0 0 0], [1 0 0]);
distTh  = 10;
dist    = matGeom.geom3d.distancePointPlane(point, plane);
testCase.assertEqual(distTh, dist, 'AbsTol', .01);

function testAboveOy(testCase)
% plane orthogonal to Ox axis
point   = [10 10 10];
plane   = matGeom.geom3d.createPlane([0 0 0], [0 1 0]);
distTh  = 10;
dist    = matGeom.geom3d.distancePointPlane(point, plane);
testCase.assertEqual(distTh, dist, 'AbsTol', .01);
...
% plane orthogonal to Ox axis
point   = [10 10 10];
plane   = matGeom.geom3d.createPlane([0 0 0], [0 0 1]);
distTh  = 10;
dist    = matGeom.geom3d.distancePointPlane(point, plane);
testCase.assertEqual(distTh, dist, 'AbsTol', .01);
...
% plane orthogonal to Ox axis
point   = [0 0 0];
plane   = matGeom.geom3d.createPlane([10 10 10], [1 0 0]);
distTh  = -10;
dist    = matGeom.geom3d.distancePointPlane(point, plane);
testCase.assertEqual(distTh, dist, 'AbsTol', .01);
...
% plane orthogonal to Ox axis
point   = [0 0 0];
plane   = matGeom.geom3d.createPlane([10 10 10], [0 1 0]);
distTh  = -10;
dist    = matGeom.geom3d.distancePointPlane(point, plane);
testCase.assertEqual(distTh, dist, 'AbsTol', .01);
...
% plane orthogonal to Ox axis
point   = [0 0 0];
plane   = matGeom.geom3d.createPlane([10 10 10], [0 0 1]);
distTh  = -10;
dist    = matGeom.geom3d.distancePointPlane(point, plane);
testCase.assertEqual(distTh, dist, 'AbsTol', .01);
...
plane   = matGeom.geom3d.createPlane([0 0 0], [1 0 0]);
distTh  =  [10;10;10;10];
dist    = matGeom.geom3d.distancePointPlane(points, plane);
testCase.assertEqual(distTh, dist, 'AbsTol', .01);

function testPlaneArray(testCase)

point   = [0 0 0];
planes  = matGeom.geom3d.createPlane([10 0 0;10 20 30;10 10 10;10 0 20], [1 0 0]);
distTh  =  [-10;-10;-10;-10];
dist    = matGeom.geom3d.distancePointPlane(point, planes);
testCase.assertEqual(distTh, dist, 'AbsTol', .01);
...
planes  = matGeom.geom3d.createPlane([10 0 0;10 20 30;10 10 10;10 0 20], [1 0 0]);
distTh  =  [-10;-10;-10;-10];
dist    = matGeom.geom3d.distancePointPlane(points, planes);
testCase.assertEqual(distTh, dist, 'AbsTol', .01);
