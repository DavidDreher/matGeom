...
[x, y, z] = matGeom.geom3d.sph2cart2d(0, 0, 1);
...
[x, y, z] = matGeom.geom3d.sph2cart2d(90, 0, 10);
...
[x, y, z] = matGeom.geom3d.sph2cart2d(90, 45, 10*sqrt(2));
testCase.assertEqual(10, x, 'AbsTol', .01);
...
res = matGeom.geom3d.sph2cart2d([0, 0, 1]);
