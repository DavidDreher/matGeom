...
warning('matGeom:deprecated', ...
    'function "ellipseAsCurve" is deprecated, use "matGeom.geom2d.ellipseToPolygon" instead');

% format output
if nargout <= 1
    varargout = {matGeom.geom2d.ellipseToPolygon(ellipse, N)};
else
    [x, y] = matGeom.geom2d.ellipseToPolygon(ellipse, N);
    varargout = {x, y};
end
