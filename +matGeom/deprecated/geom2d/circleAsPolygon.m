...
warning('matGeom:deprecated', ...
    'function "circleAsPolygon" is deprecated, use "matGeom.geom2d.circleToPolygon" instead');

% format output
if nargout <= 1
    varargout = {matGeom.geom2d.circleToPolygon(circle, varargin{:})};
else
    [x, y] = matGeom.geom2d.circleToPolygon(circle, varargin{:});
    varargout = {x, y};
end
