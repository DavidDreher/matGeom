...
for i=1:size(line, 1)
	...
	px1 = matGeom.geom2d.intersectLineEdge(line(i,:), [x y x+w y]);
	px2 = matGeom.geom2d.intersectLineEdge(line(i,:), [x+w y x+w y+h]);
	py1 = matGeom.geom2d.intersectLineEdge(line(i,:), [x+w y+h x y+h]);
	py2 = matGeom.geom2d.intersectLineEdge(line(i,:), [x y+h x y]);
