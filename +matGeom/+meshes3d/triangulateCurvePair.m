...
% needed
p1 = curve1(1, :);
if matGeom.geom2d.distancePoints(p1, curve2(1,:)) > matGeom.geom2d.distancePoints(p1, curve2(end,:))
...
for i = 1:nFacets
    ...
    dist1 = matGeom.geom2d.distancePoints(curve1(currentIndex1, :), curve2(nextIndex2,:));
    dist2 = matGeom.geom2d.distancePoints(curve1(nextIndex1, :), curve2(currentIndex2,:));
