...
% create base torus
circle = matGeom.geom2d.circleToPolygon([r1 0 r2], nTheta);
[x, y, z] = matGeom.geom3d.revolutionSurface(circle, linspace(0, 2*pi, nPhi));
...
% convert to FV mesh
[vertices, faces] = matGeom.meshes3d.surfToMesh(x, y, z, 'xPeriodic', true, 'yPeriodic', true);
