...
[dists, inds] = matGeom.geom2d.minDistancePoints(poly1, poly2);
...
for i = 1:nFacets
    ...
    dist1 = matGeom.geom2d.distancePoints(poly1(currentIndex1, :), poly2(nextIndex2,:));
    dist2 = matGeom.geom2d.distancePoints(poly1(nextIndex1, :), poly2(currentIndex2,:));
