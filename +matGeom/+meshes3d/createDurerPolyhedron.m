...
%   http://en.wikipedia.org/wiki/D�er_graph
...
v    = v -.5;
rot1 = matGeom.geom3d.createRotationOz(pi/4);
rot2 = matGeom.geom3d.createRotationOy(asec(sqrt(3)));
sca  = matGeom.geom3d.createScaling3d([1 1 sqrt(1+3/sqrt(5))]);
v = matGeom.geom3d.transformPoint3d(v, sca * rot2 * rot1);
...
plane1  = matGeom.geom3d.createPlane([0 0 z1], [0 0 1]);
[v, f]   = matGeom.meshes3d.clipConvexPolyhedronHP(v, f, plane1);
plane2  = matGeom.geom3d.createPlane([0 0 -z1], [0 0 -1]);
[v, f]   = matGeom.meshes3d.clipConvexPolyhedronHP(v, f, plane2);

% complete with edge information
e = matGeom.meshes3d.meshEdges(f);
