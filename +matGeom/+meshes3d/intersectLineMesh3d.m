...
if iscell(faces) || size(faces, 2) ~= 3
    [faces, tri2Face] = matGeom.meshes3d.triangulateFaces(faces);
end
...
% triangle normal
n   = matGeom.geom3d.normalizeVector3d(matGeom.geom3d.crossProduct3d(u, v));
...
valid = abs(b) > tol & matGeom.geom3d.vectorNorm3d(n) > tol;
