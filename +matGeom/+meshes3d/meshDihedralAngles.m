...
normals = matGeom.meshes3d.meshFaceNormals(vertices, faces);

% indices of faces adjacent to each edge
edgeFaces = matGeom.meshes3d.meshEdgeFaces(vertices, edges, faces);
...
for i = 1:Ne
    ...
    alpha(i) = matGeom.geom3d.vectorAngle3d(normal1, normal2);
end
