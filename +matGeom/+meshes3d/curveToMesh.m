...
for iNode = 1:nNodes
    ...
    tangentVector = matGeom.geom3d.normalizeVector3d(curve(iNext, :) - node);

    % convert to spherical coordinates
    [theta, phi, rho] = matGeom.geom3d.cart2sph2(tangentVector); %#ok<ASGLU>
    ...
    trans = matGeom.geom3d.createTranslation3d(node);
    transformMatrix = trans * rotZ * rotY;
    corners = matGeom.geom3d.transformPoint3d(baseCorners, transformMatrix);
