...
hold on;
h1 = matGeom.geom3d.drawSphericalEdge(sphere, [v1 v2], varargin{:});
h2 = matGeom.geom3d.drawSphericalEdge(sphere, [v2 v3], varargin{:});
h3 = matGeom.geom3d.drawSphericalEdge(sphere, [v3 v1], varargin{:});
