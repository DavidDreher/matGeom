...
hold on;
matGeom.geom3d.drawCylinder([origin origin+v1*L r], 16, 'facecolor', 'r', 'edgecolor', 'none');
matGeom.geom3d.drawCylinder([origin origin+v2*L r], 16, 'facecolor', 'g', 'edgecolor', 'none');
matGeom.geom3d.drawCylinder([origin origin+v3*L r], 16, 'facecolor', 'b', 'edgecolor', 'none');
matGeom.geom3d.drawSphere([origin 2*r], 'faceColor', 'black');
