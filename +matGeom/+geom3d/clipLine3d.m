...
for i=1:Nl
    ...
    ipZ0 = matGeom.geom3d.intersectLinePlane(line(i,:), planeZ0);
    ipZ1 = matGeom.geom3d.intersectLinePlane(line(i,:), planeZ1);
    ipY0 = matGeom.geom3d.intersectLinePlane(line(i,:), planeY0);
    ipY1 = matGeom.geom3d.intersectLinePlane(line(i,:), planeY1);
    ipX1 = matGeom.geom3d.intersectLinePlane(line(i,:), planeX1);
    ipX0 = matGeom.geom3d.intersectLinePlane(line(i,:), planeX0);

    % concatenate resulting points
    points  = [ipX0;ipX1;ipY0;ipY1;ipZ0;ipZ1];

    % compute position of each point on the line
    pos     = matGeom.geom3d.linePosition3d(points, line(i,:));
