...
matGeom.geom3d.drawPolyline3d(u(1,:), v(1,:), z(1,:))
matGeom.geom3d.drawPolyline3d(u(end,:), v(end,:), z(end,:))
matGeom.geom3d.drawPolyline3d(u(:,end), v(:,end), z(:,end))
matGeom.geom3d.drawPolyline3d(u(:,1), v(:,1), z(:,1))
...
if ~isempty(varargin)
    pos = varargin{1};
    matGeom.geom3d.drawPolyline3d(u(pos(1),:), v(pos(1),:), z(pos(1),:));
    matGeom.geom3d.drawPolyline3d(u(:,pos(2)), v(:,pos(2)), z(:,pos(2)));
end
