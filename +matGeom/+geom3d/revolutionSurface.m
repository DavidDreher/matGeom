...
tra = matGeom.geom2d.createTranslation(-revol(1:2));
rot = matGeom.geom2d.createRotation(pi/2 - matGeom.geom2d.lineAngle(revol));
[xt, yt] = matGeom.geom2d.transformPoint(xt, yt, tra*rot);
