...
for y = ye:dy:yf
    for z = ze:dz:zf
        h = [h; matGeom.geom3d.drawEdge3d([x0 y z x1 y z])]; %#ok<AGROW>
    end
end
...
for x = xe:dx:xf
    for z = ze:dz:zf
        h = [h; matGeom.geom3d.drawEdge3d([x y0 z x y1 z])]; %#ok<AGROW>
    end
end
...
for x = xe:dx:xf
    for y = ye:dy:yf
        h = [h; matGeom.geom3d.drawEdge3d([x y z0 x y z1])]; %#ok<AGROW>
    end
end
