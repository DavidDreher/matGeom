...
below = matGeom.geom3d.isBelowPlane(poly, plane);
...
while i <= N
    ...
    if below(i)
        ...
        line = matGeom.geom3d.createLine3d(poly(i-1, :), poly(i, :));
        inter1 = matGeom.geom3d.intersectLinePlane(line, plane);
        poly2(j, :) = inter1;
        j = j + 1;
        ...
        i2 = mod(i - 1, N) + 1;
        line = matGeom.geom3d.createLine3d(poly(i2-1, :), poly(i2, :));
        inter2 = matGeom.geom3d.intersectLinePlane(line, plane);
        poly2(j, :) = inter2;
        j = j + 1;
