...
circle0 = matGeom.geom3d.projPointOnPlane(center, plane);

% radius of circles
d   = matGeom.geom3d.distancePoints3d(center, circle0);
Rc  = sqrt(Rs.*Rs - d.*d);

% normal of planes = normal of circles
nor = matGeom.geom3d.planeNormal(plane);

% convert to angles
[theta, phi] = matGeom.geom3d.cart2sph2(nor(:,1), nor(:,2), nor(:,3));
psi = zeros(Np, 1);
