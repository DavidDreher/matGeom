...
sca     = matGeom.geom3d.createScaling3d(a);
rot1    = matGeom.geom3d.createRotationOz(psi);
rot2    = matGeom.geom3d.createRotationOy(theta);
rot3    = matGeom.geom3d.createRotationOz(phi);
