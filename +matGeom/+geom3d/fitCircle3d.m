...
tfmPoints = matGeom.geom3d.transformPoint3d(centeredPoints, V');
...
center3d = matGeom.geom3d.transformPoint3d([center2d, 0], [inv(V'), meanPoint']);
circleNormal = V(:,3)';
[theta, phi, ~] = matGeom.geom3d.cart2sph2(circleNormal);
fittedCircle = [center3d radius matGeom.geom2d.rad2deg(theta) matGeom.geom2d.rad2deg(phi) 0];
