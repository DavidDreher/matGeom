...
v1  = matGeom.geom3d.normalizeVector3d(p1 - ori);
v2  = matGeom.geom3d.normalizeVector3d(p2 - ori);
v3  = matGeom.geom3d.normalizeVector3d(p3 - ori);

% create a plane tangent to the sphere containing first point
plane = matGeom.geom3d.createPlane(v1, v1);

% position on the plane of the direction vectors
pp2 = matGeom.geom3d.planePosition(matGeom.geom3d.intersectLinePlane([ori v2], plane), plane);
pp3 = matGeom.geom3d.planePosition(matGeom.geom3d.intersectLinePlane([ori v3], plane), plane);
