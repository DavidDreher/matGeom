...
if isnumeric(source)
    ...
    t1(1:3, 3, :) = matGeom.geom3d.crossProduct3d(source(1,4:6,:), source(1,7:9,:));
...
if isnumeric(target)
    ...
    t2(1:3, 3, :) = matGeom.geom3d.crossProduct3d(target(1,4:6,:), target(1,7:9,:));
...
for i = 1:maxSz
    ...
    t2i = inv(t2(:,:,i));
    pot = matGeom.geom3d.transformPoint3d(po, t2i);
    pxt = matGeom.geom3d.transformPoint3d(px, t2i);
    pyt = matGeom.geom3d.transformPoint3d(py, t2i);
    pzt = matGeom.geom3d.transformPoint3d(pz, t2i);
