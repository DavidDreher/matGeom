...
% plane normal
n1 = matGeom.geom3d.normalizeVector3d(cross(plane1(:,4:6), plane1(:, 7:9), 2));
n2 = matGeom.geom3d.normalizeVector3d(cross(plane2(:,4:6), plane2(:, 7:9), 2));
n3 = matGeom.geom3d.normalizeVector3d(cross(plane3(:,4:6), plane3(:, 7:9), 2));
