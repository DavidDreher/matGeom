...
plane2 = [...
    matGeom.geom3d.transformPoint3d( plane(:,1:3), trans) ...  % transform origin point
    matGeom.geom3d.transformVector3d(plane(:,4:6), trans) ...  % transform 1st dir. vect.
    matGeom.geom3d.transformVector3d(plane(:,7:9), trans)];    % transform 2nd dir. vect.
