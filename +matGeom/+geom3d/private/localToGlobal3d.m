...
rot1    = matGeom.geom3d.createRotationOz(psi * k);

% colatitude
rot2    = matGeom.geom3d.createRotationOy(theta * k);

% longitude
rot3    = matGeom.geom3d.createRotationOz(phi * k);

% shift center
tr      = matGeom.geom3d.createTranslation3d(center);
