...
valFun = @(x) size(x,1)==1 && matGeom.geom3d.isPlane(x);
defOpts.FaceColor='m';
[hAx, plane, varargin]=...
...
piX00 = matGeom.geom3d.intersectLinePlane(lineX00, plane);
piX01 = matGeom.geom3d.intersectLinePlane(lineX01, plane);
piX10 = matGeom.geom3d.intersectLinePlane(lineX10, plane);
piX11 = matGeom.geom3d.intersectLinePlane(lineX11, plane);
piY00 = matGeom.geom3d.intersectLinePlane(lineY00, plane);
piY01 = matGeom.geom3d.intersectLinePlane(lineY01, plane);
piY10 = matGeom.geom3d.intersectLinePlane(lineY10, plane);
piY11 = matGeom.geom3d.intersectLinePlane(lineY11, plane);
piZ00 = matGeom.geom3d.intersectLinePlane(lineZ00, plane);
piZ01 = matGeom.geom3d.intersectLinePlane(lineZ01, plane);
piZ10 = matGeom.geom3d.intersectLinePlane(lineZ10, plane);
piZ11 = matGeom.geom3d.intersectLinePlane(lineZ11, plane);
...
u1 = matGeom.geom3d.linePosition3d(pts, d1);
u2 = matGeom.geom3d.linePosition3d(pts, d2);
