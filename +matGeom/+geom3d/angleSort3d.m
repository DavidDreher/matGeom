...
plane   = matGeom.geom3d.createPlane(pts(1:3, :));

% project points onto the plane
pts2d   = matGeom.geom3d.planePosition(pts, plane);
pt0     = matGeom.geom3d.planePosition(pt0, plane);
pt1     = matGeom.geom3d.planePosition(pt1, plane);
