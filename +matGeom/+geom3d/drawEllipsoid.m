...
sca     = matGeom.geom3d.createScaling3d(a, b, c);
rotZ    = matGeom.geom3d.createRotationOz(ellPhi);
rotY    = matGeom.geom3d.createRotationOy(ellTheta);
rotX    = matGeom.geom3d.createRotationOx(ellPsi);
tra     = matGeom.geom3d.createTranslation3d([xc yc zc]);
...
[x, y, z] = matGeom.geom3d.transformPoint3d(x, y, z, trans);
...
if drawEllipses
    ...
    [xc1, yc1, zc1] = matGeom.geom3d.transformPoint3d(xc1, yc1, zc1, trans);
    [xc2, yc2, zc2] = matGeom.geom3d.transformPoint3d(xc2, yc2, zc2, trans);
    [xc3, yc3, zc3] = matGeom.geom3d.transformPoint3d(xc3, yc3, zc3, trans);
end
...
if drawAxes
    ...
    axesEndings = matGeom.geom3d.transformPoint3d(axesEndings, trans);
end
...
if nargout == 0
    ...
    if drawAxes
        matGeom.geom3d.drawEdge3d([axesEndings(1,:), axesEndings(2,:)], axesOptions{:});
        matGeom.geom3d.drawEdge3d([axesEndings(3,:), axesEndings(4,:)], axesOptions{:});
        matGeom.geom3d.drawEdge3d([axesEndings(5,:), axesEndings(6,:)], axesOptions{:});
    end
