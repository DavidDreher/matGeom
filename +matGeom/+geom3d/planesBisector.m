...
n1 = matGeom.geom3d.planeNormal(plane1);	% the normal of the plane
% d1 = -dot(n1, P1);		% for line equation

P2 = plane2(1:3);
n2 = matGeom.geom3d.planeNormal(plane2);
% d2 = -dot(n2, P2);

if ~isequal(P1(1:3), P2(1:3))
	L = matGeom.geom3d.intersectPlanes(plane1, plane2);	% intersection of the given two planes
...
out = matGeom.geom3d.createPlane(Pt, n1 - n2);
