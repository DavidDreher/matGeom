...
ts = matGeom.geom3d.linePosition3d(points, axis);
...
if ~isempty(ind1)
    plane = matGeom.geom3d.createPlane(c1, dc);
    points(ind1, :) = matGeom.geom3d.intersectLinePlane(line, plane);
end
if ~isempty(ind2)
    plane = matGeom.geom3d.createPlane(c2, dc);
    points(ind2, :) = matGeom.geom3d.intersectLinePlane(line, plane);
end
