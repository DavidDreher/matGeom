...
d1  = matGeom.geom3d.normalizeVector3d(plane1(:,4:6));

% compute second direction vector
n   = matGeom.geom3d.normalizeVector3d(matGeom.geom3d.planeNormal(plane1));
d2  = -matGeom.geom3d.normalizeVector3d(matGeom.geom3d.crossProduct3d(d1, n));

% compute origin point of the plane
origins = repmat([0 0 0], [size(plane1, 1) 1]);
p0 = matGeom.geom3d.projPointOnPlane(origins, [plane1(:,1:3) d1 d2]);
