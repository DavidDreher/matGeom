...
pts = matGeom.polygons2d.intersectPolylines(poly1([1:end 1], :), poly2([1:end 1], :));
if size(pts, 1) > 0
    dist = 0;
    return;
end
...
dist1   = min(matGeom.polygons2d.distancePointPolygon(poly1, poly2));
dist2   = min(matGeom.polygons2d.distancePointPolygon(poly2, poly1));
