...
[inters, pos1, pos2] = matGeom.polygons2d.polygonSelfIntersections(poly, 'tolerance', tol);
...
pos0 = 0;
loop = matGeom.polygons2d.polygonSubcurve(poly, pos0, positions(1, 1));
loop(end, :) = inters(1,:);
vertex = inters(1,:);
...
while true
    ...
    portion = matGeom.polygons2d.polygonSubcurve(poly, pos, positions(ind, 1));
...
loop = [loop ; matGeom.polygons2d.polygonSubcurve(poly, pos, pos0)];
