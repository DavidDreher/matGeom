...
elseif nargin == 3
    ...
    line1 = matGeom.geom2d.medianLine(p1, p2);
    line2 = matGeom.geom2d.medianLine(p1, p3);
    center = matGeom.geom2d.intersectLines(line1, line2);
    x0 = center(:, 1); 
    y0 = center(:, 2);
    ...
    angle = matGeom.geom2d.angle3Points(p1, center, p2) + matGeom.geom2d.angle3Points(p2, center, p3);
    d = angle>2*pi;
end
