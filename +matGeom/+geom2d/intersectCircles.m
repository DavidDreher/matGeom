...
d12 = matGeom.geom2d.distancePoints(center1, center2, 'diag');
...
angle = matGeom.geom2d.angle2Points(center1(inds,:), center2(inds,:));
...
tmp = matGeom.geom2d.polarPoint(center1(inds, :), d1m, angle);
...
points(inds1, :) = matGeom.geom2d.polarPoint(tmp, h, angle - pi/2);
points(inds2, :) = matGeom.geom2d.polarPoint(tmp, h, angle + pi/2);
