...
if length(varargin)==2
    ...
    point = matGeom.geom2d.intersectLines(line1, line2);    
...
elseif length(varargin)==3
    ...
    line1 = matGeom.geom2d.createLine(p2, p1);
    line2 = matGeom.geom2d.createLine(p2, p3);
    point = p2;
...
% compute line angles
a1 = matGeom.geom2d.lineAngle(line1);
a2 = matGeom.geom2d.lineAngle(line2);
