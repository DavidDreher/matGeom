...
lines = [lines ; matGeom.geom2d.createLine(box, dx, dy) Inf*ones(4,2)];
...
while true    
	...
	for i=1:size(points, 1)
        ...
        pi = matGeom.geom2d.intersectLines(lines(i,:), lines);
        
        % compute position of all intersection points on the current line 
        pos = matGeom.geom2d.linePosition(pi, lines(i,:));
        ...
        for i2=1:length(indr2)
            ...
            pos2 = matGeom.geom2d.linePosition(pi(il, :), lines(il, :));
