...
for i = 1:nLines
    ...
    px1 = matGeom.geom2d.intersectLines(line(i,:), [xmin ymin delta 0]);   % lower edge
    px2 = matGeom.geom2d.intersectLines(line(i,:), [xmax ymin 0 delta]);   % right edge
    py1 = matGeom.geom2d.intersectLines(line(i,:), [xmax ymax -delta 0]);  % upper edge
    py2 = matGeom.geom2d.intersectLines(line(i,:), [xmin ymax 0 -delta]);  % left edge
    ...
    pos = matGeom.geom2d.linePosition(points, line(i,:));
