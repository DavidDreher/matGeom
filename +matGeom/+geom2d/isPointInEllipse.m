...
rot = matGeom.geom2d.createRotation(-matGeom.geom2d.deg2rad(ellipse(5)));
sca = matGeom.geom2d.createScaling(1./ellipse(3:4));
trans = sca * rot;

% transform points to unit circle basis
pTrans = bsxfun(@minus, point, ellipse(:,1:2));
pTrans = matGeom.geom2d.transformPoint(pTrans, trans);
