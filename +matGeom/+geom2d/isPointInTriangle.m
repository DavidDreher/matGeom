...
isDirect = matGeom.geom2d.isCounterClockwise(p1, p2, p3);

% check location of point with respect to each side
if isDirect
    b12 = matGeom.geom2d.isCounterClockwise(p1, p2, point) >= 0;
    b23 = matGeom.geom2d.isCounterClockwise(p2, p3, point) >= 0;
    b31 = matGeom.geom2d.isCounterClockwise(p3, p1, point) >= 0;
else
    b12 = matGeom.geom2d.isCounterClockwise(p1, p2, point) <= 0;
    b23 = matGeom.geom2d.isCounterClockwise(p2, p3, point) <= 0;
    b31 = matGeom.geom2d.isCounterClockwise(p3, p1, point) <= 0;
