...
pts1 = matGeom.geom2d.squareGrid(bounds, origin + [0 0],        [dx dy], varargin{:});
pts2 = matGeom.geom2d.squareGrid(bounds, origin + [dx/3 0],     [dx dy], varargin{:});
pts3 = matGeom.geom2d.squareGrid(bounds, origin + [dx/2 dy/2],  [dx dy], varargin{:});
pts4 = matGeom.geom2d.squareGrid(bounds, origin + [-dx/6 dy/2], [dx dy], varargin{:});
