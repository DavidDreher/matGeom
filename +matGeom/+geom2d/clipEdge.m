...
for i = 1:length(ind)
    ...
    px0 = matGeom.geom2d.intersectLineEdge(lineX0, iedge);
    px1 = matGeom.geom2d.intersectLineEdge(lineX1, iedge);
    py0 = matGeom.geom2d.intersectLineEdge(lineY0, iedge);
    py1 = matGeom.geom2d.intersectLineEdge(lineY1, iedge);
