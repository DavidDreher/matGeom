...
par = matGeom.geom2d.isParallel(edge1(:,3:4)-edge1(:,1:2), edge2(:,3:4)-edge2(:,1:2));
...
if sum(col) > 0
    ...
    t1 = matGeom.geom2d.edgePosition(edge2(col, 1:2), edge1(col, :));
    t2 = matGeom.geom2d.edgePosition(edge2(col, 3:4), edge1(col, :));
