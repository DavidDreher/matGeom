...
edge = matGeom.geom2d.clipLine(ray, box);
...
pos2 = zeros(n, 1);
for i = 1:n
    pos1(i) = matGeom.geom2d.linePosition(edge(inds(i),1:2), ray(inds(i),:));
    pos2(i) = matGeom.geom2d.linePosition(edge(inds(i),3:4), ray(inds(i),:));
end
