...
nFaces = matGeom.meshes3d.meshFaceNumber(vertices, faces);

energyList = zeros(nFaces, 1);

polygons = matGeom.meshes3d.meshFacePolygons(vertices, faces);
for i = 1:nFaces
    [Ix, Iy, Ixy] = matGeom.polygons2d.polygonSecondAreaMoments(polygons{i}); %#ok<ASGLU>
