...
for i = 1:nEdges
    edgeLengths(i) = matGeom.geom2d.distancePoints(points(E(i,1),:), points(E(i,2),:));
end
...
for iEdge = 1:nEdges
    ...
    dists1 = matGeom.geom2d.distancePoints(vertex1, points(inds, :));
    dists2 = matGeom.geom2d.distancePoints(vertex2, points(inds, :));
