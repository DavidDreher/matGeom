...
inds = matGeom.graphs.graphPeripheralVertices(nodes, edges, edgeWeights);
ind0 = inds(end);

% find a vertex opposite to the first extremity
dists = matGeom.graphs.grPropagateDistance(nodes, edges, ind0, edgeWeights);
...
while true
    ...
    neighs = matGeom.graphs.grAdjacentNodes(edges, ind1);
