...
matGeom.geom2d.drawPoint(matGeom.polygons2d.polylineSelfIntersections(poly2, 'closed'), 'ro');
...
matGeom.polygons2d.drawPolygon(matGeom.polygons2d.expandPolygon(poly, 10));
